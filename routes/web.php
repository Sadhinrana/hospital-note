...
Route::get('mail-view', function () {
    $medical_report = \App\MedicalReport::first();
    return new \App\Mail\MedicalReportMail($medical_report, 'Hello world');
});

// medical report email
Route::get('/patient-medical-report/{encrypted_id}', 'MedicalReportController@patientMedialReport');
Route::post('patient-medical-report-store', 'MedicalReportController@patientMedialReportStore')->name('patient-medical-report.store');
...
// Video Conference
Route::get('video/appointment/conference/{code}', 'AppointmentsController@videoAppointmentConference')->name('appointment.video.conference');
Route::post('video/appointment/conference/upload', 'AppointmentsController@uploadVideo')->name('appointment.video.upload');

Route::group(['middleware' => 'auth'], function () {
    Route::post('patients/sendSMS', 'PatientsController@sendSMS')
        ->name('patients.sendSMS');
    Route::get('patients-by-doctor/{id}', 'PatientsController@patientsByDoctor')
    ...
    Route::post('video/appointment/conference/download/{appointment_record}', 'AppointmentsController@downloadVideo')->name('appointment.video.download');
    ...
    Route::post('/patient_ajax2', 'PatientsController@patient_ajax2');
    Route::post('/medication_ajax', 'MedicationsController@medication_ajax');
    Route::get('medications/ajax', 'MedicationsController@medications')->name('medications.ajax');
    ...
    Route::post('email-medical-report', 'MedicalReportController@sendMailToPatient')->name('medical-report.email');
});
