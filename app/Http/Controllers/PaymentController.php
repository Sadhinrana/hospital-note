    ...
    public function stripeRedirect(Request $request)
    {
        try {
            ...
            if (auth()->user()->company) {
                ...
                User::where('id', auth()->user()->companies->first()->user_id)->update(['stripe_response' => json_encode($response), 'stripe_user_id' => $response->stripe_user_id]);
            }
    ...
    public function disconnect()
    {
        try {
            ...
            if (auth()->user()->company) {
                ...
                User::where('id', auth()->user()->companies->first()->user_id)->update(['stripe_response' => null, 'stripe_user_id' => null]);
            }
