...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('settings.index', compact('companydetails', 'tasks', 'patients', 'doctors', 'services', 'taxes', 'charges', 'currencies', 'paymentmethods', 'medications', 'trashed', 'room_count'));
    }
}
