...
class DrugsController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if (\request()->ajax()) {
            return response()->json(['status' => 200, 'data' => $drug]);
        } else {
    ...
    public function update(UpdateDrugs $request, $id)
    {
        ...
        return redirect()->route('prescriptions.show', $request->prescription_id)->with('success', 'Prescription Update Successfully.');
    }
