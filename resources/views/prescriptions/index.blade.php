    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-4">
                    <a href="{{route('prescriptions.create')}}" class="btn btn-sm btn-primary btn-block"><i
                            class="fa fa-plus"></i> Create New prescription</a>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <a href="{{route('prescriptions.show', $prescription->id)}}"
                                           class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> View</a>
                                    </div>
                                    <div class="col-md-8">
