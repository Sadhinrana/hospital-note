...
@section('content')
    ...
    <div class="row" style="padding: 2%;">
        @if($drugs->count() > 0)
            ...
            <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal" onclick="cancelAllergy();clearForm()"><i
                        class="fa fa-plus"></i>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{route('drugs.store')}}" method="post" id="drug-form" style="padding: 1%;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name='dosage' id="dosage" class="form-control" placeholder="Enter dose and directions..." required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name='duration_quantity' id="duration_quantity" class="form-control" placeholder="Enter duration or quantity..." required>
                            </div>

                            <div class="col-md-6">
                                <label>Pharmacy (Dispensed by)</label>
                                <input type="text" name='dispensed_by' id="dispensed_by" class="form-control" placeholder="Enter pharmacist name...">
                            </div>
                        </div>
                        <hr>
