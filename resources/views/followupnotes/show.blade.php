    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="row">
                ...
                <div class="col-md-4">
                    @if(auth()->user()->role_id != 4 && $consultation->status != 1)
                    <a href="{{route('followupnotes.edit', $consultation->id)}}" class="btn btn-sm btn-primary btn-block"><i class="fa fa-pencil"></i> Edit consultation</a>
                    @endif
                </div>
            </div>
        </div>
    </div>
    @include('inc.tabMenu', ['tabMenuPosition' => 1, 'patient_id' => $consultation->user_id])
