    ...
    <div class="col-lg-3 col-md-6 col-xs-12">
        ...
        <div class="small-box bg-blue-gradient">
            <div class="inner">
                ...
                <p>Bookings</p>
                <p>Since @if(App\Appointment::first()){{date('d M, Y', strtotime(App\Appointment::first()->value('created_at')))}}@endif</p>
            </div>
            <div class="icon">
                <i class="ion ion-clipboard"></i>
            </div>
    ...
    <div class="col-lg-3 col-md-6 col-xs-12">
        ...
        <div class="small-box bg-gray">
            <div class="inner">
                ...
                <p>Customers</p>
                <p>Since @if(App\User::first()){{date('d M, Y', strtotime(App\User::first()->value('created_at')))}}@endif</p>
            </div>
            <div class="icon">
                <i class="ion ion-person-stalker"></i>
            </div>
