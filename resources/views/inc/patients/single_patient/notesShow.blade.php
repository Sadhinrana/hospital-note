...
@section('content')
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            @include('inc.tabMenu', ['tabMenuPosition' => 1, 'patient_id' => $patientTreatmentNote->user_id])
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <table class="table no-border table-striped table-hover">
                        @if($patientTreatmentNote->template->is_show_patients_nhs_number && $patientTreatmentNote->creator)
                            <tr>
                                <th>Practitioner</th>
                                <td>{{ $patientTreatmentNote->creator->firstname .' '. $patientTreatmentNote->creator->lastname }}</td>
                            </tr>
                        @endif
