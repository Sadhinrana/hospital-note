<div class="row">
    @if(auth()->user()->role_id == 1 || auth()->user()->role_id == 2 || auth()->user()->role_id == 6)
        ...
        @if(auth()->user()->role_id == 1 || auth()->user()->role_id == 2 || (auth()->user()->role_id == 6 && auth()->user()->company->sms_enabled))
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
    ...
    @if(auth()->user()->role_id == 1 || auth()->user()->role_id == 2 || auth()->user()->role_id == 6)
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon bg-green"><i class="fa fa-fw fa-home"></i></span>
