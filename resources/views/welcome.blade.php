...
<body>
        ...
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            <div class="wow bounceIn" data-animation-delay="7.8s">
              ...
              <h6>
              Try every feature now with HospitalNote's 30-day free trial! No payment information required. Just create an account and get full access to every HospitalNote feature. When your 30 days are up, simply enter your payment details, and continue enjoying all that HospitalNote has to offer.
              </h6>
  ...
  margin-right: auto; width: 100px; height: 100px;">
                      ...
                      <h2 class="align-center"><a href="#">{{$service->title}}</a></h2>
                      <p style="font-size: 10px;">{!!$service->content!!}</p>
                    </div>
                  </div>
                </div>
              </div>
...
<!-- Pricing -->
<section id="section-pricing" class="team-section appear clearfix">
  <div class="container">
      ...
      <div class="col-md-offset-3 col-md-6">
        <div class="section-header">
          <div class="wow bounceIn">
            ...
            <h2 class="section-heading animated" data-animation="bounceInUp">Pricing</h2>
            <p>HospitalNote clinic management software is free to try for the first 30 days. Subscriptions are then priced according to how many practitioners there are in your practice. SMS messages sent from HospitalNote cost an additional 7p each.</p>
        ...
        <div class="pricing-table-wrap" data-scrollreveal="enter top over 0.5s after 0.5s">
          <ul class="line-highlight">
            ...
            <li class="line-btn-row">
              <a href="#section-contact" class="line-btn green">Get Started</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          @endforeach
      @else
          <strong class="text-center">No Pricing</strong>
      @endif
      ...
      <div class="row mar-bot40">
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            ...
            <p>Contact us today to arrange a demo or to have a chat with our experienced team to run over your requirements.</p>
          </div>
        </div>
      </div>
      <div class="row">
