            ...
            <form action="{{route('users.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select onchange="getService()" name="role_id" id="role_id" class="form-control">
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{$role->role_id}}" data-role_type="{{$role->role_type}}">{{$role->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="service col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="specialism" value="{{old('specialism')}}" placeholder="eg. General Practitioner">
                        </div>
                    </div>
                    ...
                    <div class="service col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qualifications" value="{{old('qualifications')}}" placeholder="eg. MBBS">
                        </div>
                    </div>
                    ...
                    <div class="service col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="med_co_no" value="{{old('med_co_no')}}" placeholder="eg. DME6085">
                        </div>
                    </div>
                    ...
                    <div class="service col-md-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mdu_no" value="{{old('mdu_no')}}" placeholder="eg. 467033C">
                        </div>
                    </div>
                    ...
                    <div class="service col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="summernote form-control" name="qualifications_details" placeholder="MBBS - Bachelor of Medicine and Surgery">{{old('qualifications_details')}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="service col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="summernote form-control" name="gp_med_co_legal_experience" placeholder="GP Medico-Legal Experience">{{old('gp_med_co_legal_experience')}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="service col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="summernote form-control" name="med_co_legal_experience" placeholder="Medico-Legal Experience">{{old('med_co_legal_experience')}}</textarea>
                        </div>
                    </div>
                </div>
                <hr>
                ...
                <div class="row" style="padding: 1%;">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="more_info" id="more_info" placeholder="Enter more information about the user...">{{old('more_info')}}</textarea>
                    </div>
                </div> <hr>
