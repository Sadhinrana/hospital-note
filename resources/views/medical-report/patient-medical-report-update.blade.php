...
<head>
    ...
    <title>Patient medical report update</title>
            ...
            <div class="col-sm-10">
                <div class="panel panel-success">
                    ...
                    <div id="report-wrapper-forms" class="panel-body">
                        <form action="{{ route('patient-medical-report.store') }}" method="post">
                            @csrf
                            <input name="encrypted_id" value="{{ $encrypted_id }}" type="hidden"/>
...
<script>
    ...
    let reportOptions = {
        ...
        "accident": {
            ...
            "after_accident": "",
            "sourceImpact": "",
            "protection": "The vehicle was fitted with air bags and these were properly adjusted and fastened at the time of the accident. The airbag was not activated. The client  was wearing a seatbelt.",
            "impactSeverity": "",
            "circumstance": "",
            "movement": "",
            "position": "",
    ...
    new Vue({
        ...
        methods: {
            ...
            selectPatient() {
                let patient = this.patients.filter(patient => patient.id == this.reportData.claimant.id);
                console.log(patient);
                if (patient.length > 0) {
