        ...
        <div class="panel-body">
            ...
            <form action="{{route('services.update', $service->id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="price" value="{{$service->price}}" class="form-control" placeholder="Enter Service Price...">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="is_payment" {{ $service->is_payment ? 'checked' : '' }}>
                </div>
                <div class="form-group">
